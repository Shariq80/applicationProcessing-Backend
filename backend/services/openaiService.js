...
const processResume = async (resumeText, jobDescription) => {
  try {
    ...
    const prompt = `Analyze the following resume against the job description and provide a score indicating the suitability of the resume to the job description and summary after analysis:
